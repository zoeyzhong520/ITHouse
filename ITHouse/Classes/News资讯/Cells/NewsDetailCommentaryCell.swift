//
//  NewsDetailCommentaryCell.swift
//  ITHouse
//
...
@objc protocol NewsDetailCommentaryCellDelegate: NSObjectProtocol {
    @objc optional
    func clickBtn(withTag tag: Int, model: NewsDetailCommentary?)
}

class NewsDetailCommentaryCell: UITableViewCell {
    
    weak var delegate: NewsDetailCommentaryCellDelegate?
    ...
    fileprivate func addViews() {
        ...
        contentView.addSubview(subCommentBtn)
