//
//  NewsDetailMoreCommentaryTableHeaderView.swift
//  ITHouse
//
...
@objc protocol NewsDetailMoreCommentaryTableHeaderViewDelegate: NSObjectProtocol {
    @objc optional
    func clickBtn(withTag tag: Int, model: NewsDetailCommentary?)
}

class NewsDetailMoreCommentaryTableHeaderView: UIView {
    
    weak var delegate: NewsDetailMoreCommentaryTableHeaderViewDelegate?
